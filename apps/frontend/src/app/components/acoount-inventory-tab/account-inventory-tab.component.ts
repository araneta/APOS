...
import { AccountInventoryDialogComponent } from '../account-inventory-dialog/account-inventory-dialog.component';
import { LoadingService } from '../../loading.service';

@Component({
  selector: 'app-account-inventory-tab',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, SimpleTableComponent, AccountInventoryDialogComponent],
...
export class AccountInventoryTabComponent implements OnInit {
  ...
  sortName = '';
  sortOrder = 'asc';
  @ViewChild('modalRef') modalComponent!: AccountInventoryDialogComponent;
