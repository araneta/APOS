...
@Component({
  selector: 'app-account-expense-tab',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, SimpleTableComponent],           
    templateUrl: './account-expense-tab.component.html',           
    //styleUrls: ['./account-Expense-tab.component.scss']
})
export class AccountExpenseTabComponent implements OnInit {
    ...
    getColumnDefs = () => [
        ...
        { headerName: 'Expense/Bank', field: 'isExpenseBank' },
    ...
    public loadDataExpenseAccounts = (state: any) => {
